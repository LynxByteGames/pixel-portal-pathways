...
const SplitHero = () => {
  ...
  return <div className="flex flex-col md:flex-row min-h-screen pt-16" style={{
    background: 'linear-gradient(135deg, #6a79f3 0%, #c083e2 100%)'
  }}>
      {/* Developer Section */}
      <div className="hero-section flex-1 bg-cover bg-center relative overflow-hidden" style={{
      ...
      {/* Publisher Section */}
      <div className="hero-section flex-1 bg-cover bg-center" style={{
