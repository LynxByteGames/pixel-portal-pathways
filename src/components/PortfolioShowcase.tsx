...
const GameCard = ({ game, index }) => {
  return (
    ...
    >
      <Card className="overflow-hidden bg-white/5 backdrop-blur-sm border border-white/10 transition-all duration-500 hover:scale-[1.03] hover:border-purple-primary/40 hover:shadow-lg hover:shadow-purple-primary/20 group h-full">
...
const PortfolioShowcase = () => {
  ...
  return (
    <section className="py-24 relative overflow-hidden" id="portfolio">
      {/* Background effect */}
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1511512578047-dfb367046420?ixlib=rb-1.2.1&auto=format&fit=crop&q=80')] bg-cover bg-fixed bg-center opacity-5"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="hidden md:flex justify-center mb-10 space-x-2">
